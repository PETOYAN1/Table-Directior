...
<body style="background: linear-gradient(196deg, #dc3545, black);">
	<div class="limiter">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						...
						<span class="focus-input100" style="color: rgba(184, 76, 70, 0.8);"></span>
						<span class="symbol-input100" style="color: rgba(184, 76, 70, 0.8);">
					...
					<div class="container-login100-form-btn">
						<button name="submit" class="login100-form-btn bg-danger">
							Login
						</button>
					</div>
					<div class="text-center p-t-136">
						<a class="txt2" href="SignInEmployee.php">
							I am employee
